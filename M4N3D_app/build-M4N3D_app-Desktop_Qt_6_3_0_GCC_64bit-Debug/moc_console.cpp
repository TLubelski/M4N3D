...
#include <memory>
#include "../M4N3D_app/inc/console.hpp"
...
QT_MOC_LITERAL(8, 12), // "enterPressed"
QT_MOC_LITERAL(21, 0), // ""
QT_MOC_LITERAL(22, 10), // "QKeyEvent*"
QT_MOC_LITERAL(33, 5) // "event"

    },
    "Console\0enterPressed\0\0QKeyEvent*\0event"
};
...
void Console::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->enterPressed((*reinterpret_cast< std::add_pointer_t<QKeyEvent*>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Console::*)(QKeyEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Console::enterPressed)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Console, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QKeyEvent *, std::false_type>
...
// SIGNAL 0
void Console::enterPressed(QKeyEvent * _t1)
{
