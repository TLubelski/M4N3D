...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOC, ANALOG_L_X_Pin|ANALOG_L_Y_Pin|ANALOG_R_X_Pin|ANALOG_R_Y_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA9     ------> USART1_TX
    */
    HAL_GPIO_DeInit(SRV_UART_RXTX_GPIO_Port, SRV_UART_RXTX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, TTY_UART_TX_Pin|TTY_UART_RX_Pin);
